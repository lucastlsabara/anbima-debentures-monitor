"""Mapeamento heurístico de papel ANBIMA -> setor objetivo do emissor.

Classificação é feita por (1) palavras-chave no nome do emissor,
(2) prefixo do código da debênture (4 letras). Default: "Outros".
"""
